...
!(function () {
        ...
        return e
            ? ((i = t[0]),
              ...
              i % Math.PI == 0
                  ...
                  : ((r = Math.sin(l) * Math.cos(s) + Math.cos(l) * Math.sin(s) * Math.cos(i)), Math.abs(r) > 0.99 ? ((p = Math.abs(Math.acos(Math.sqrt(a * a + n * n)))), r < 0 && (p *= -1)) : (p = Math.asin(r))),
              [d, p])
            : t;
    }
    function n(t) {
    ...
    function c(t) {
        for (var e = {}, a = t.features, n = 0; n < a.length; n++) e[a[n].id] = { center: a[n].properties.display.slice(0, 2), scale: a[n].properties.display[2] };
        return e;
    }
    function d(t) {
        var e = { type: "FeatureCollection", features: [{ type: "Feature", geometry: { type: "MultiPolygon", coordinates: [] } }] },
    ...
    function f(t, e, a) {
        ...
        for (var p = n; p <= r; p += s) {
            var u = a;
            "lat" === l ? ((i = [d, p]), (o = p.toString() + "°"), (u += p < 0 ? "S" : "N")) : "ra" === l ? ((i = [15 * p, d]), (o = p.toString() + "ʰ")) : ((i = [p, d]), (o = p.toString() + "°")),
    ...
    function I(t) {
        if (t) {
            ...
            if (!(e.length < 1) && ((e = e[0].split("-")), (e[0] = e[0].replace(/\D/g, "")), e[0]))
                return (e[1] = e[1] ? e[1].replace(/\D/g, "") : "1"), (e[2] = e[2] ? e[2].replace(/\D/g, "") : "1"), new Date(Date.UTC(e[0], e[1] - 1, e[2]));
        }
    }
    function q(t, e, a) {
    ...
    function L(t) {
        ...
        function c(t) {
            var a,
                n = [],
                r = bt;
            if ("---" === t) return (tt.constellation = null), (a = tt.zoomBy()), 1 !== a && n.push({ param: "zoom", value: 1 / a, duration: 0 }), void tt.animate(n, !1);
            if (S(tt.constellations) && k(tt.constellations, t)) {
                var s = tt.constellations[t],
                    o = e(s.center, gt[r.transform]);
                (r.center = o), C(r.center, r.transform), (a = tt.zoomBy()), 1 !== a && n.push({ param: "zoom", value: 1 / a, duration: 0 }), n.push({ param: "center", value: o, duration: 0 });
                var i = 1 + 360 / s.scale;
        ...
        function d() {
            ...
            null !== t &&
                (p(e.id, t),
                "dsos-style-fill" === e.id ? (p("dsos-style-stroke", t), p("dsos-nameStyle-fill", t)) : "constellations-namesType" === e.id ? U() : "lang" === e.id ? u(t) : "advanced" === e.id && B(t),
                o(),
                Object.assign(bt, m),
                tt.apply(m));
        }
        ...
        function u(t) {
            ...
            for (var e = ["constellations", "planets"], a = 0; a < e.length; a++)
                k(zt[e[a]][m.culture].names, t) ? (m[e[a]].namesType = t) : k(zt[e[a]][m.culture].names, "desig") ? (m[e[a]].namesType = "desig") : (m[e[a]].namesType = "name");
            return (
        ...
        w.append("label").attr("title", "Map width in pixel, 0 indicates full width").attr("for", "width").html("Width "),
            w.append("input").attr("type", "number").attr("maxlength", "4").attr("max", "20000").attr("min", "0").attr("title", "Map width").attr("id", "width").attr("value", m.width).on("change", a),
            w.append("span").html("px"),
            w.append("label").attr("title", "Map projection, (hemi) indicates hemispherical projection").attr("for", "projection").html("Projection");
        ...
        x
            ...
            (T = 0),
            w.append("label").attr("title", "Coordinate space in which the map is displayed").attr("for", "transform").html("Coordinates"),
            ...
            x.property("selectedIndex", T),
            w.append("br"),
            w.append("label").attr("title", "Center coordinates long/lat in selected coordinate space").attr("for", "centerx").html("Center"),
            w.append("input").attr("type", "number").attr("id", "centerx").attr("title", "Center right ascension/longitude").attr("max", "24").attr("min", "0").attr("step", "0.1").on("change", s),
            w.append("span").attr("id", "cxunit").html("h"),
            w.append("input").attr("type", "number").attr("id", "centery").attr("title", "Center declination/latitude").attr("max", "90").attr("min", "-90").attr("step", "0.1").on("change", s),
            w.append("span").html("°"),
            w.append("label").attr("title", "Orientation").attr("for", "centerz").html("Orientation"),
            w.append("input").attr("type", "number").attr("id", "centerz").attr("title", "Center orientation").attr("max", "180").attr("min", "-180").attr("step", "0.1").on("change", s),
            w.append("span").html("°"),
            w.append("label").attr("for", "orientationfixed").attr("class", "advanced").html("Fixed"),
            w.append("input").attr("type", "checkbox").attr("id", "orientationfixed").attr("class", "advanced").property("checked", m.orientationfixed).on("change", d),
            w.append("label").attr("title", "Center and zoom in on this constellation").attr("for", "constellation").html("Show"),
            ...
            w.append("input").attr("type", "checkbox").attr("id", "stars-show").property("checked", m.stars.show).on("change", d),
            w.append("label").attr("for", "stars-limit").html("down to magnitude"),
            w.append("input").attr("type", "number").attr("id", "stars-limit").attr("title", "Star display limit (magnitude)").attr("value", m.stars.limit).attr("max", "6").attr("min", "-1").attr("step", "0.1").on("change", d),
            w.append("label").attr("for", "stars-colors").html("with spectral colors"),
            w.append("input").attr("type", "checkbox").attr("id", "stars-colors").property("checked", m.stars.colors).on("change", d),
            w.append("label").attr("for", "stars-color").html("or default color "),
            w.append("input").attr("type", "color").attr("autocomplete", "off").attr("id", "stars-style-fill").attr("title", "Star color").property("value", m.stars.style.fill).on("change", d),
            w.append("br");
        ...
        w.append("br"),
            ...
            w.append("label").attr("class", "header").attr("title", "Deep Space Objects").attr("for", "dsos-show").html("DSOs"),
            w.append("input").attr("type", "checkbox").attr("id", "dsos-show").property("checked", m.dsos.show).on("change", d),
            w.append("label").attr("for", "dsos-limit").html("down to mag"),
            w.append("input").attr("type", "number").attr("id", "dsos-limit").attr("title", "DSO display limit (magnitude)").attr("value", m.dsos.limit).attr("max", "6").attr("min", "0").attr("step", "0.1").on("change", d),
            w.append("label").attr("for", "dsos-colors").html("with symbol colors"),
            w.append("input").attr("type", "checkbox").attr("id", "dsos-colors").property("checked", m.dsos.colors).on("change", d),
            w.append("label").attr("for", "dsos-color").html("or default color "),
            w.append("input").attr("type", "color").attr("autocomplete", "off").attr("id", "dsos-style-fill").attr("title", "DSO color").property("value", m.dsos.style.fill).on("change", d),
            w.append("br"),
        ...
        w.append("label").attr("for", "dsos-nameLimit").html("down to mag"),
            w.append("input").attr("type", "number").attr("id", "dsos-nameLimit").attr("title", "DSO name display limit (magnitude)").attr("value", m.dsos.nameLimit).attr("max", "6").attr("min", "0").attr("step", "0.1").on("change", d),
            w.append("br"),
            ...
            w
                ...
                .attr("step", "0.1")
                .on("change", d),
            w.append("label").attr("for", "dsos-exponent").attr("class", "advanced").html(" * 2 [* adaptation] - magnitude) ^ exponent"),
            w
                .append("input")
                .attr("type", "number")
        ...
        w.append("label").attr("for", "constellations-lines").html(" lines"),
            w.append("input").attr("type", "checkbox").attr("id", "constellations-lines").property("checked", m.constellations.lines).on("change", d),
            w.append("label").attr("for", "constellations-bounds").html(" boundaries"),
            w.append("input").attr("type", "checkbox").attr("id", "constellations-bounds").property("checked", m.constellations.bounds).on("change", d),
            ...
            w.append("input").attr("type", "checkbox").attr("id", "lines-graticule-show").property("checked", m.lines.graticule.show).on("change", d),
            w.append("label").attr("for", "lines-equatorial").html("Equator"),
            w.append("input").attr("type", "checkbox").attr("id", "lines-equatorial-show").property("checked", m.lines.equatorial.show).on("change", d),
            w.append("label").attr("for", "lines-ecliptic").html("Ecliptic"),
            w.append("input").attr("type", "checkbox").attr("id", "lines-ecliptic-show").property("checked", m.lines.ecliptic.show).on("change", d),
            w.append("label").attr("for", "lines-galactic").html("Galactic plane"),
            w.append("input").attr("type", "checkbox").attr("id", "lines-galactic-show").property("checked", m.lines.galactic.show).on("change", d),
            w.append("label").attr("for", "lines-supergalactic").html("Supergalactic plane"),
            w.append("input").attr("type", "checkbox").attr("id", "lines-supergalactic-show").property("checked", m.lines.supergalactic.show).on("change", d),
            ...
            w.append("input").attr("type", "color").attr("id", "mw-style-fill").attr("class", "advanced").attr("title", "Milky Way color").attr("value", m.mw.style.fill).on("change", d),
            ...
            w.append("input").attr("type", "color").attr("id", "background-fill").attr("title", "Background color").attr("value", m.background.fill).on("change", d),
            ...
            w
                ...
                .attr("step", "0.01")
                .on("change", d),
            w.append("label").attr("title", "Star/DSO sizes are increased with higher zoom-levels").attr("for", "adaptable").attr("class", "advanced").html("Adaptable object sizes"),
            w.append("input").attr("type", "checkbox").attr("id", "adaptable").attr("class", "advanced").property("checked", m.adaptable).on("change", d);
        var F = St[m.culture];
        (T = 0),
        ...
        return a
            ? (e &&
                  ("equatorial" === t && "equatorial" !== e
                      ...
                      : "equatorial" !== t && "equatorial" === e && ((a.value = (15 * a.value).toFixed(1)), a.value > 180 && (a.value -= 360))),
              "equatorial" === t ? ((a.min = "0"), (a.max = "24"), (W("cxunit").innerHTML = "h")) : ((a.min = "-180"), (a.max = "180"), (W("cxunit").innerHTML = "°")),
              a.value)
            : null;
    }
    function C(t, e) {
        ...
        a &&
            ...
            (a.value = "equatorial" !== e ? t[0].toFixed(1) : t[0] < 0 ? (t[0] / 15 + 24).toFixed(1) : (t[0] / 15).toFixed(1)),
    ...
    function H() {
        ...
        return (
            ...
            6 != r.s && ((W("stars-limit").max = r.s), (W("stars-designationLimit").max = r.s), (W("stars-propernameLimit").max = r.s)),
            r
        );
    }
    function B(t) {
    ...
    function U() {
        ...
        if (
            (tt.container.selectAll(".constname").each(function (a, o) {
                (t = a.id), t === s.constellation && (r = o), (e = a.properties[s.constellations.namesType]), e !== t && (e += " (" + t + ")"), n.push({ o: t, n: e });
            }),
    ...
    function V(t) {
        ...
        function l() {
            ...
            if ((Object.assign(y, wt.set()), (h = d.parse(W("datetime").value.slice(0, -6))), !isNaN(t) && !isNaN(e))) {
                ...
                (p = tt.getPoint(vt.inverse(a, [90, 0], u), y.transform)), (p[2] = 0), "zenith" === y.follow ? tt.rotate({ center: p }) : tt.redraw();
            }
        }
        function c(t, e) {
            if (t && k(y, "settimezone") && !1 !== y.settimezone) {
                ...
                d3.json(s, function (e, n) {
                    ...
                    "FAILED" === n.status ? ((m = 60 * Math.round(t[1] / 15)), (At = { gmtOffset: 60 * m, message: "Sea locatation inferred", timestamp: a })) : ((m = n.gmtOffset / 60), (At = n)), (W("datetime").value = r(h, m)), l();
                });
            }
        }
        ...
        M.append("label").attr("title", "Location coordinates long/lat").attr("for", "lat").html("Location"),
            ...
            M.append("span").html("°"),
            "geolocation" in navigator && M.append("input").attr("type", "button").attr("value", "Here").attr("id", "here").on("click", a),
            ...
            M.append("input").attr("type", "checkbox").attr("id", "horizon-show").property("checked", y.horizon.show).on("change", i),
            M.append("label").attr("title", "Show daylight").attr("for", "daylight-show").html("Daylight sky"),
            M.append("input").attr("type", "checkbox").attr("id", "daylight-show").property("checked", y.daylight.show).on("change", i),
            M.append("br"),
            M.append("label").attr("title", "Show solar system objects").attr("for", "planets-show").html(" Planets, Sun & Moon"),
            M.append("input").attr("type", "checkbox").attr("id", "planets-show").property("checked", y.planets.show).on("change", i);
        ...
        D(W("planets-show")),
            ...
            (tt.skyview = function (t) {
                ...
                return (
                    ...
                    k(t, "location") && s(t.location) && ((u = t.location.slice()), (W("lat").value = u[0]), (W("lon").value = u[1]), !k(t, "timezone"))
                        ? void c(u, !k(t, "date"))
                        : !1 === e
    ...
    function R(t) {
        ...
        function p(t, e) {
            ...
            t <= 1.36
                ...
                : ((a = (t - 1.36) / (1.885 - 1.36)), (n = d3.interpolateLab("#daf1fa", "#e8c866")(a)), (r = d3.interpolateLab("#93c7d0", "#ff854a")(a)), (s = d3.interpolateLab("#57b0c8", "#6caae2")(a)));
        ...
        function g(t, e) {
            return t && 999 !== t ? Math.pow(2 * E.dsos.size * W - t, E.dsos.exponent) : Math.pow((parseInt(e) * E.dsos.size * W) / 7, 0.5);
        }
        function v(t) {
        ...
        function I(t) {
            ...
            return (
                ...
                ("symbol" !== E.planets.symbolType && "letter" !== E.planets.symbolType) || (e.properties.symbol = E.planets.symbols[e.id][E.planets.symbolType]),
        ...
        var D,
            F,
            O = (d3.select("body").append("div").attr("id", "d3-celestial-svg").attr("style", "display: none"), d3.select("#d3-celestial-svg").append("svg")),
            _ = tt.metrics(),
            E = wt.set(),
            N = E.datapath,
            C = xt[E.projection],
        ...
        for (
            ...
            (Y[$[K]] = O.append("g").attr({ id: $[K], ":inkscape:groupmode": "layer", ":inkscape:label": $[K] })), (J[$[K]] = {});
        ...
        if ((Y.background.append("path").datum(D).attr("class", "background").attr("d", Z), (J.background.fill = E.background.fill), E.lines.graticule.show)) {
            if (
                ("equatorial" === E.transform
                    ? (Y.gridLines.append("path").datum(Q).attr("class", "gridLines").attr("d", Z), (J.gridLines = i(E.lines.graticule)))
        ...
        E.mw.show &&
                ...
                d3.json(N + "mw.json", function (e, a) {
                    ...
                    Y.milkyWay.selectAll(".mway").data(n.features).enter().append("path").attr("class", "milkyWay").attr("d", Z),
                        ...
                        (!k(E.background, "opacity") || E.background.opacity > 0.95) &&
                            (Y.milkyWayBg.selectAll(".mwaybg").data(r.features).enter().append("path").attr("class", "milkyWayBg").attr("d", Z), (J.milkyWayBg = { fill: E.background.fill, "fill-opacity": E.background.opacity })),
                        t(null);
                });
            }),
                ...
                X.defer(function (t) {
                    d3.json(N + s("constellations", "borders"), function (e, a) {
                        ...
                        Y.constBoundaries
                            ...
                            (J.constBoundariesSel = { fill: "none", stroke: E.constellations.boundStyle.stroke, "stroke-width": 1.5 * E.constellations.boundStyle.width, "stroke-opacity": 1, "stroke-dasharray": "none" }),
                            t(null);
                    });
                }),
            E.constellations.lines &&
                X.defer(function (t) {
                    d3.json(N + s("constellations", "lines"), function (e, a) {
                        ...
                        (J.constLines1 = { fill: "none", stroke: E.constellations.lineStyle.stroke[0], "stroke-width": E.constellations.lineStyle.width[0], "stroke-opacity": E.constellations.lineStyle.opacity[0], "stroke-dasharray": r }),
                            (J.constLines2 = {
                                fill: "none",
            ...
            X.defer(function (t) {
                ...
                U.rotate([0, 0, 0]),
                    ...
                    (J.mapBorder = { fill: "none", stroke: E.background.stroke, "stroke-width": E.background.width, "stroke-opacity": 1, "stroke-dasharray": "none" }),
                    U.rotate(e),
                    t(null);
            }),
                ...
                X.defer(function (t) {
                    d3.json(N + s("constellations"), function (e, n) {
                        ...
                        Y.constNames
                            ...
                            (J.constNames1 = { fill: E.constellations.nameStyle.fill[0], "fill-opacity": E.constellations.nameStyle.opacity[0], font: E.constellations.nameStyle.font[0], "text-anchor": f(E.constellations.nameStyle.align) }),
                            (J.constNames2 = { fill: E.constellations.nameStyle.fill[1], "fill-opacity": E.constellations.nameStyle.opacity[1], font: E.constellations.nameStyle.font[1], "text-anchor": f(E.constellations.nameStyle.align) }),
                            (J.constNames3 = { fill: E.constellations.nameStyle.fill[2], "fill-opacity": E.constellations.nameStyle.opacity[2], font: E.constellations.nameStyle.font[2], "text-anchor": f(E.constellations.nameStyle.align) }),
                            t(null);
                    });
                }),
            E.stars.show &&
                X.defer(function (t) {
                    d3.json(N + E.stars.data, function (e, n) {
                        ...
                        var l = kt.domain();
                        for (K = b(l[1], 1); K <= b(l[0], 1); K += 0.1) J["stars" + Math.round(10 * K).toString()] = { fill: kt(K) };
                        E.stars.designation &&
                            (Y.starDesignations
                        ...
                        for (nt in E.dsos.symbols)
                            k(E.dsos.symbols, nt) &&
                                ...
                                k(E.dsos.symbols[nt], "stroke")
                                    ? ((J[F].fill = "none"), (J[F].stroke = E.dsos.colors ? E.dsos.symbols[nt].stroke : E.dsos.style.stroke), (J[F]["stroke-width"] = E.dsos.colors ? E.dsos.symbols[nt].width : E.dsos.style.width))
                                    : ((J[F].stroke = "none"), (J[F].fill = E.dsos.colors ? E.dsos.symbols[nt].fill : E.dsos.style.fill)));
                        if (E.dsos.names) {
                            Y.dsoNames
                                .selectAll(".dsonames")
                                .data(
                                ...
                                .attr({ dy: "-.5em", dx: ".35em" }),
                                (J.dsoNames = { "fill-opacity": E.dsos.style.opacity, font: E.dsos.nameStyle.font, "text-anchor": f(E.dsos.nameStyle.align) });
                            for (nt in E.dsos.symbols) k(E.dsos.symbols, nt) && (J[nt] = { fill: E.dsos.colors ? E.dsos.symbols[nt].fill : E.dsos.style.fill });
                        }
                        t(null);
                    });
                }),
            (E.location || E.formFields.location) &&
                ...
                X.defer(function (t) {
                    ...
                    (J.planets = c(E.planets.symbolStyle)), (J.planets.font = P(E.planets.symbolStyle.font)), (J.darkluna = { fill: "#557" });
                ...
                X.defer(function (t) {
                    ...
                    if (e) {
                        ...
                        Y.daylight.append("path").datum(i).attr("class", "daylight").attr("d", Z),
                            (J.daylight = p(s, o)),
                            1 === a(r) && s < mt && Y.daylight.append("circle").attr("cx", o[0]).attr("cy", o[1]).attr("r", 5).style("fill", "#fff");
                    }
                    t(null);
                }),
            (E.location || E.formFields.location) &&
    ...
    if (
        ((tt.display = function (a) {
                        ...
                        qt.selectAll(J + " .star").each(function (t) {
                            if (S(t.geometry.coordinates) && t.properties.mag <= $.stars.limit) {
                                ...
                                (ee.fillStyle = pt(t)),
                                    ...
                                    ee.closePath(),
                                    ee.fill(),
                                    $.stars.designation && t.properties.mag <= $.stars.designationLimit * Kt && (j($.stars.designationStyle), ee.fillText(W(t.id), e[0] + a, e[1])),
                                    $.stars.propername && t.properties.mag <= $.stars.propernameLimit * Kt && (j($.stars.propernameStyle), ee.fillText(R(t.id), e[0] - a, e[1]));
                            }
                        })),
                    $.dsos.show &&
                        qt.selectAll(J + " .dso").each(function (t) {
                            if (S(t.geometry.coordinates) && E(t.properties, $.dsos.limit)) {
                                ...
                                k($.dsos.symbols[a], "stroke") ? ee.stroke() : ee.fill(),
                                    $.dsos.names && E(t.properties, $.dsos.nameLimit * Kt) && (j($.dsos.nameStyle), !0 === $.dsos.colors && (ee.fillStyle = $.dsos.symbols[a].fill), ee.fillText(G(t), e[0] + n, e[1] - n));
                            }
                        }),
                                ...
                                ("letter" === $.planets.symbolType
                                    ...
                                    ? ((s = k(c, "size") && x(c.size) ? c.size * Kt : ft(o.ephemeris)),
                                      ...
                                      Tt.symbol()
                                          ...
                                          .position(l)(ee),
                                      ee.fill())
                                    : "symbol" === $.planets.symbolType && (j($.planets.symbolStyle), (ee.font = yt($.planets.symbolStyle.font)), (ee.fillStyle = c.fill), ee.fillText(c[$.planets.symbolType], l[0], l[1])),
                                $.planets.names)
                            ) {
            ...
            function A(t, e) {
                ...
                o.addColorStop(0, n), o.addColorStop(0.2 + 0.4 * a, r), o.addColorStop(1, s), (ee.fillStyle = o), (ee.globalAlpha = 0.9 * (1 - I(a, 1.4)));
            }
            function I(t, e) {
            ...
            function B(t) {
                return t.mag && 999 !== t.mag ? Math.pow(2 * $t * Kt - t.mag, Jt) : Math.pow((parseInt(t.dim) * $t * Kt) / 7, 0.5);
            }
            function G(t) {
            ...
            if (Bt) {
                ...
                (Q = d3.geo.path().projection(Y).context(ee)),
                    ...
                    (!0 !== $.location && !0 !== $.formFields.location) || (d3.select(J + " #location").style("display", "inline-block"), F("horizon-show", Bt.clip), F("daylight-show", !Bt.clip)),
                    (this.container = qt),
                    (this.clip = S),
                    (this.map = Q),
    ...
    var ut = { equatorial: [0, 0, 0], ecliptic: [0, 0, 23.4393], galactic: [93.5949, 28.9362, -58.5988], supergalactic: [137.31, 59.5283, 57.7303] },
        ht = { equatorial: [0, 90], ecliptic: [-90, 66.5607], galactic: [-167.1405, 27.1283], supergalactic: [-76.2458, 15.7089] };
        ...
        return k(t, "type")
            ? ("dso" !== t.type && "json" !== t.type) || (k(t, "file") && k(t, "callback"))
                ? ("line" !== t.type && "raw" !== t.type) || k(t, "callback")
                    ? (k(t, "file") && (e.file = t.file), (e.type = t.type), k(t, "callback") && (e.callback = t.callback), k(t, "redraw") && (e.redraw = t.redraw), k(t, "save") && (e.save = t.save), void tt.data.push(e))
    ...
    var bt = {},
        wt = {
            ...
            form: !1,
            location: !1,
            formFields: { location: !0, general: !0, stars: !0, dsos: !0, constellations: !0, lines: !0, other: !0, download: !1 },
            advanced: !0,
            daterange: [],
            settimezone: !0,
                ...
                return (
                    ...
                    t &&
                        ...
                        k(t, "constellations") &&
                            ...
                            k(t.constellations, "boundstyle") && Object.assign(e.constellations.boundStyle, t.constellations.boundstyle)),
    ...
    var zt = {
            starnames: {
                iau: {
                    designation: { desig: "Designation", bayer: "Bayer", flam: "Flamsteed", var: "Variable", gl: "Gliese", hd: "Draper", hip: "Hipparcos" },
                    propername: {
                        name: "IAU Name",
                        ar: "Arabic",
                        zh: "Chinese",
                ...
                cn: { propername: { name: "Proper name", en: "English", pinyin: "Pinyin" }, designation: { desig: "IAU Designation" } },
            },
            constellations: {
                iau: {
                    names: {
            ...
            planets: {
                ...
                cn: { symbol: { symbol: "☾ Symbol", letter: "Ⅼ Letter", disk: "● Disk" }, names: { desig: "Designation", name: "Chinese", pinyin: "Pinyin", en: "English" } },
            },
            dsonames: {
                iau: {
                    names: {
            ...
            o =
                (d3.functor([2, 2]),
                {
                    ...
                    ellipse: function (t) {
                        var a = Math.sqrt(n()),
                            r = a / 2;
                        return t.save(), t.translate(e[0], e[1]), t.scale(1.6, 0.8), t.beginPath(), t.arc(0, 0, r, 0, 2 * Math.PI), t.closePath(), t.restore(), r;
                    },
                    marker: function (t) {
                        var a = Math.sqrt(n()),
                            r = a / 2;
    ...
    var jt = {
        ...
        qt = { sol: "☉", mer: "☿", ven: "♀", ter: "⊕", lun: "●", mar: "♂", cer: "⚳", ves: "⚶", jup: "♃", sat: "♄", ura: "♅", nep: "♆", plu: "♇", eri: "⚪" },
        Lt = 23.43928 * yt,
        Dt = Math.sin(Lt),
        Ft = Math.cos(Lt),
        ...
        _t = function () {
            ...
            function a() {
                ...
                if (
                    ...
                    (l *= Math.abs(1 - o)),
                    l < 1e-15 && (l = 1e-15),
                    ((o > 0.8 && i < Math.PI / 3) || o > 1) && ((n = i / Math.abs(1 - o)), n * n > 6 * Math.abs(1 - o) && (n = i < Math.PI ? Math.pow(6 * i, 1 / 3) : jt.asinh(i / o)), (t = n)),
                    o > 1 && i > 4 && (t = Math.log(i)),
                    o < 1)
                )
                    for (; Math.abs(d) > l; ) (a = u++ > 8 ? e(t, o) - i : t - o * Math.sin(t) - i), (d = -a / (1 - o * Math.cos(t))), (t += d);
                else for (; Math.abs(d) > l; ) (a = u++ > 7 ? -e(t, o) - i : o * jt.sinh(t) - t - i), (d = -a / (o * jt.cosh(t) - 1)), (t += d);
                return p ? c - t : c + t;
            }
            function n() {
                var t,
                    ...
                    o = M.ephemeris;
                1 === o.e
                    ? ((s = o.jd0 - o.T), (r = o.w0 * s * 0.5), (e = Math.pow(r + Math.sqrt(r * r + 1), 1 / 3)), (o.v = 2 * Math.atan(e - 1 / e)))
                    : ((o.E = a()), o.e > 1 ? ((t = o.e - jt.cosh(o.E)), (e = jt.sinh(o.E))) : ((t = Math.cos(o.E) - o.e), (e = Math.sin(o.E))), (e *= Math.sqrt(Math.abs(1 - o.e * o.e))), (o.v = Math.atan2(e, t))),
                    (n = o.q * (1 + o.e)),
            ...
            function r() {
                ...
                t.hasOwnProperty("w") || (t.w = t.W - t.N),
                    ...
                    1 !== t.e ? ((t.q = t.a * (1 - t.e)), (t.t0 = t.a * Math.sqrt(Math.abs(t.a) / y))) : ((t.w0 = 3 / Math.sqrt(2) / (t.q * Math.sqrt(t.q / y))), (t.a = 0), (t.t0 = 0)),
            ...
            function o(t) {
                var e = M.ephemeris,
                    a = t.ephemeris;
                (Lt = (23.439292 - 0.0130042 * e.cy - 1.667e-7 * e.cy * e.cy + 5.028e-7 * e.cy * e.cy * e.cy) * yt), (Dt = Math.sin(Lt)), (Ft = Math.cos(Lt));
            ...
            return (
                ...
                (t.elements = function (e) {
                    ...
                    for (var n = 0; n < Ot.length; n++)
                        (a = Ot[n]), k(e, a) && ((v[a] = e[a]), "a" === a || "e" === a ? (v[a] *= 1) : "ref" !== a && "ep" !== a && (v[a] *= yt), k(e, "d" + a) && ((a = "d" + a), (v[a] = e[a]), (v[a] *= "da" === a || "de" === a ? 1 : yt)));
                    return t;
                }),
                (t.params = function (e) {
        ...
        Et = {
            elements: function (t) {
                var e = (t.jd - 2451545) / 36525,
                    ...
                    c = -0.55 * Math.cos(yt * (238.2 + 854535.2 * e)) + 0.1 * Math.cos(yt * (103.2 + 377336.3 * e)) + 0.1 * Math.cos(yt * (233.2 + 926533.3 * e)),
                    d = 383397.6 + l + c * e,
                    p =
            ...
            corr: function (t, e) {
                ...
                t.ra += o;
                var i = -0.003019 * Math.sin(r - 2 * s) + -959931e-9 * Math.sin(t.M - r - 2 * s) + -802851e-9 * Math.sin(t.M + r - 2 * s) + 575958e-9 * Math.sin(r + 2 * s) + 296706e-9 * Math.sin(2 * t.M + r);
        ...
        Nt = d3.map({
            ...
            crescent: function (t, e) {
                var a = Math.sqrt(t),
                    ...
                    o = e > Math.PI ? 0 : 1;
                return "M -1,-1 m 1," + (1 - n) + " a" + n + "," + n + " 0 1 " + o + " 0," + 2 * n + " a" + n * s + "," + n + " 0 1 " + (Math.abs(r) > 0.5 ? o : Math.abs(o - 1)) + " 0," + -2 * n + "z";
            },
        });
    ...
    var Ht = function (t, e) {
        function a() {
            ...
            for (o = 0; o < 42; o++) {
                ...
                n
                    .append("div")
                    .classed({ date: !0, grey: i !== t, weekend: i === t && (0 === l || 6 === l), today: 0 === A(a, r), selected: 0 === A(a, p) })
                    .attr("id", c)
                    .on("click", d)
                            ...
                            r.each("start.zoom", function () {
                                ...
                                .tween("zoom:zoom", function () {
                                    ...
                                    return (
                                        ...
                                        function (a) {
                                            var n = d(a);
                                            (this.__chart__ = M = { r: o(i(n[0] / l)), k: t / n[2] }), u.rotate(M.r).scale(M.k), g.scale(M.k), c(e);
                                        }
                                    );
                                })
